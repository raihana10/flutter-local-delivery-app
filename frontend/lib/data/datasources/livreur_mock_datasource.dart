...
class LivreurMockDatasource {
  ...
  static GainsModel get mockGains => GainsModel(
    ...
    livraisonsRecentes: [
      const LivraisonRecente(restaurant: 'Dar Zitoun',    heure: '14:30', montant: 35),
      const LivraisonRecente(restaurant: 'Café Atlas',    heure: '12:15', montant: 25),
      const LivraisonRecente(restaurant: 'Snack El Medina', heure: '10:45', montant: 20),
      const LivraisonRecente(restaurant: 'Pizza Roma',    heure: '09:00', montant: 30),
    ],
  );
