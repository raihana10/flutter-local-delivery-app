class ApiConstants {
  ...
  static const String baseUrl = 'http://10.0.2.2:3000/api'; // 10.0.2.2 = localhost depuis émulateur Android

  // --- Endpoints Livreur ---
  static const String livreurStatus   = '/livreur/status';       // PUT  → toggle En ligne/Hors ligne
  static const String livreurCommandes = '/livreur/commandes';   // GET  → commandes disponibles
