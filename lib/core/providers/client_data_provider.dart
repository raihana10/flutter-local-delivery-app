...
class ClientDataProvider extends ChangeNotifier {
  ...
  Future<void> _fetchRestaurants() async {
    restaurants = await apiService.getBusinesses('restaurant');
    notifyListeners();
  }

  Future<void> _fetchPharmacies() async {
    pharmacies = await apiService.getBusinesses('pharmacie');
    notifyListeners();
  }

  Future<void> _fetchSuperMarkets() async {
    superMarkets = await apiService.getBusinesses('super-marche');
    notifyListeners();
  }
